...
<div class="container-fluid">
    <div id="demo-5" class="row-fluid">
        <h4 style="background: white ;padding: 20px; color: #0e0e0e" class="clearfix text-center heading-4">Week Name :-{{$week->week_name}} || Start Date:-{{$week->start_date}} || End Date:-{{$week->end_date}}</h4>
                                                    ...
                                                    <div style="overflow: auto; width:100%;">
                                                        <table class="datatable">
                                                            ...
                                                            @php
                                                                ...
                                                                $students = $valuecontact->dailyWorkReport()->ChunksOnWeek($week->start_date,$week->end_date)->get();
                                                               $q = 0;
                                                            @endphp
                                                ...
                                                <div id="panel5-1-2{{$valuecontact->phone_no}}" class="tab-pane">
                                                    <div style="overflow: auto; width: 100%;">
                                                        <table class="datatable">
                                                            ...
                                                            @php
                                                                $courseData = $valuecontact->courses()->ChunksOnWeek($week->start_date,$week->end_date)->get();
                                                            @endphp
                                                            {{--@if(Count($courseData))--}}
                                                            <tbody>
    ...
    <div class="modal fade" id="myModalWeek" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body clearfix">
                    <form class="form-inline" style="padding: 15px" id="weekForm" method="post" action="{{url('/add-week')}}">
                        {{csrf_field()}}
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group" style="padding-top: 20px;" >
                                <input type="submit" id="submit_Form_Btn"  value="Save" class="btn btn-primary">
                            </div>
                        </div>
                                    ...
                                    @foreach($weeks as $keyweek => $valueweek)
                                        <tr>
                                            ...
                                            <td><a href="{{url('show-week-report'.'/'.$valueweek->id)}}" class="btn btn-success">Show</a>
                                                <a href="javascript:void(0)" data-react-id="{{$valueweek->id}}" id="editWeek" class="btn btn-primary">Edit</a>
                                            </td>
