                        ...
                        <div style="background: white;padding: 20px;">
                            ...
                            <div class="table-responsive">
                                <table class="table datatable">
                                    ...
                                    <tbody>
                                    @foreach($subjetcs->subjects as $keypay => $valuepay)
                                        <tr>
                                            <td>{{$keypay+1}}</td>
                                            <td>{{$subjetcs->branch_name}}</td>
                                            <td>{{$valuepay->subject_name}}</td>
                                            <td><a href="javascript:void(0)" data-react-id="{{$valuepay->id}}" id="editSubject" class="btn btn-primary">Edit</a></td>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" style="padding: 15px" method="post" action="{{url('/update-subject')}}">
                        {{csrf_field()}}
                        <div class="form-group" >
                            <label for="contact">Branch Name</label><br/>
                            <input type="text" required name="branch_name" readonly id="branch_name_subject" class="form-control">

                        </div>
                        <div class="form-group" >
                            <label for="contact">Subject Name</label><br/>
                            <input type="text" required name="subject_name" id="subject_name" class="form-control">
                            <input type="hidden" required name="subject_id" id="subject_id" class="form-control">
                        </div>
                        <div class="form-group" >
